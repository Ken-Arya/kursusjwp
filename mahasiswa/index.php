...
if ($_SESSION['role'] == 'admin') {
	include '../partials/navbar/mahasiswa.php'; // menampilkan header
	$no = 1; // mendeklarasikan variabel nomor
?>
	<!-- Tampilan role admin -->
	<div class="container">
		<!-- Form tambah data -->
		<form action="../controller/mahasiswa/tambah.php" method="post" class="needs-validation" novalidate>
					...
					?>
						<tr>
							...
							<td class="text-center">
								<button type="button" class="btn btn-outline-danger" onclick="myFunction('../controller/mahasiswa/delete.php?npm=', '<?= $id ?>')">
...
<?php include '../partials/footer.php'; // menampilkan footer
} else {
