...
<?php
		if (isset($_POST['submit'])) {
			...
			if ($result) {
				...
				header("Location: ../../jadwal/index.php?success=Data jadwal berhasil diubah");
			} else {
				// menampilkan notifikasi apabila eksekusi gagal
				header("Location: ../../jadwal/index.php?error=Gagal mengubah data jadwal");
			}
		}
	} else {
		header("Location: ../../");
